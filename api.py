...
async def ai_ask(req: AIRequest):
    ...
    if user:
        ...
        if is_workout_question:
            context += (
                "\n\nIMPORTANT: Keep your text response focused and not too long — you MUST leave room "
                "to also output the JSON block below. After your response add this on a NEW LINE with ONLY these exercises (max 8, exact names from catalog):\n"
