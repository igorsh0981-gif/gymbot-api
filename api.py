...
from fastapi import FastAPI, HTTPException, Request as FastAPIRequest, Header, Depends
        ...
        if card is None:
            ...
            if best:
                card = {
                    ...
                    "title": best["title"],
                    "description": _rec_description(db, user.id, best, week),
                    "cta": "Начать тренировку",
                    "split_key": best["key"],
