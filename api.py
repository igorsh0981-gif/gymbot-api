...
def _build_split_options(db, user_id: int, split_type: str) -> list:
    ...
    # Сначала не отработанное на неделе, внутри — по убыванию отдыха
    options.sort(key=lambda o: (o["done_this_week"], -o["min_rest_days"]))
    return options
...
def get_home(tg_id: int):
    ...
    with SessionLocal() as db:
        ...
        if card is None:
            ...
            available = [o for o in options if not o["done_this_week"]] or options
