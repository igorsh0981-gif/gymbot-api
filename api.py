...
def finish_workout(workout_id: int, req: FinishWorkoutRequest, tg_id: int):
    with SessionLocal() as db:
        ...
        db.commit()
        return {"ok": True, "new_achievements": new_achs}
...
ACHIEVEMENTS = [
    # Тренировки
    {"id": "first_workout",    "name": "Первый шаг",       "emoji": "👟", "desc": "Завершил первую тренировку",       "pts": 50},
    {"id": "workout_10",       "name": "Десятка",           "emoji": "🔟", "desc": "10 тренировок завершено",          "pts": 100},
    {"id": "workout_50",       "name": "Полтинник",         "emoji": "🥈", "desc": "50 тренировок завершено",          "pts": 300},
    {"id": "workout_100",      "name": "Сотня",             "emoji": "💯", "desc": "100 тренировок завершено",         "pts": 500},
    # Серии
    {"id": "streak_7",         "name": "Неделя подряд",     "emoji": "🔥", "desc": "7 дней подряд активности",        "pts": 100},
    {"id": "streak_30",        "name": "Месяц подряд",      "emoji": "🌟", "desc": "30 дней подряд активности",       "pts": 300},
    # Питание
    {"id": "nutrition_7",      "name": "Правильное питание","emoji": "🥗", "desc": "7 дней подряд вносил питание",    "pts": 100},
    # Рефералы
    {"id": "referral_1",       "name": "Пригласил друга",   "emoji": "🤝", "desc": "Пригласил первого друга",         "pts": 100},
    {"id": "referral_5",       "name": "Амбассадор",        "emoji": "📢", "desc": "Пригласил 5 друзей",              "pts": 300},
    # Разнообразие
    {"id": "sport_variety",    "name": "Многоборец",        "emoji": "⚽", "desc": "Занимался 5 разными видами спорта","pts": 150},
    {"id": "first_record",     "name": "Рекордсмен",        "emoji": "🏆", "desc": "Побил первый личный рекорд",      "pts": 100},
    # Вес
    {"id": "checkin_10",       "name": "Дисциплина",        "emoji": "📊", "desc": "10 чек-инов выполнено",           "pts": 100},
    {"id": "weight_goal",      "name": "Цель достигнута",   "emoji": "🎯", "desc": "Достиг целевого веса",            "pts": 500},
]
...
def get_strength_norms(tg_id: int):
    ...
    with SessionLocal() as db:
        ...
        for exercise, levels in STRENGTH_NORMS_MALE.items():
            ...
            user_val = user_max_map.get(exercise)
